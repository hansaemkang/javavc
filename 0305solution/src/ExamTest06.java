...
public class ExamTest06 {
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		System.out.println("*** 난수가 발생하였습니다...맞추어 보세요...***\n");
		while(a>0){
			System.out.print("숫자 입력 : "+sc.nextInt());
			if(sc.nextInt()<a){
				System.out.println("컴퓨터의 숫자가 더 큽니다..");tmp++;
			}
			else if(sc.nextInt()>a){
				System.out.println("컴퓨터의 숫자가 더 작습니다.");tmp++;
				}
			else
				
				System.out.println("추카추카 "+tmp+"번만에 맞추셨습니다.");break;
		}
	}
}
*/